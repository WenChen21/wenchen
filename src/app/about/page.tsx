        ...
        <div className="flex gap-x-5 w-full">
          <div className="w-1/3">
            ...
            <div className="flex mt-10">
              <Image alt="image" src={"/catan.png"} width={150} height={150} />
              <Image alt="image" src={"/chess.webp"} width={150} height={150} />
            </div>
          </div>
          <p className="text-[18px] text-white font-sans font-semibold w-2/3">
            ...
            experience building robust and dynamic web applications. Outside of
            coding, I love playing board games like chess and Catan, staying
            active through running, and playing pickleball. I&rsquo;m always
            eager to learn, collaborate, and create impactful digital solutions.
            ...
            applications that they are passionate about. Currently I am part of
            the workshop team, where I prepare and teach HTML, CSS, and
