  ...
  const projects = [
    {
      ...
      description: "A comprehensive roommate matching service tailored for Cornell students, integrating both roommate and housing search functionalities into a single platform. The backend was implemented using Supabase, Node.js, and Express.js to manage server-side logic and database operations, while the frontend was built with JavaScript, HTML, and TailwindCSS to ensure a responsive and user-friendly interface.",
      image: "/roomie.png",
      technologies: ["JavaScript", "Node.js", "Express.js", "Supabase", "TailwindCSS", "HTML"],
    ...
    },
    {
      ...
      description: "Chirp is a Twitter-like message board using only emojis, built with the T3 stack. This project showcases full-stack development skills, including handling data flow between frontend and backend, working with middleware, and efficient data handling. The application was migrated from PlanetScale to Supabase for cost optimization.",
      image: "/chirplogo.png",
      technologies: ["TypeScript", "React", "Next.js", "Prisma", "tRPC", "Supabase", "TailwindCSS"],
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-6 text-lg max-w-2xl mx-auto">
            A detailed look at my projects, showcasing technical skills and problem-solving abilities
          </p>
        </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                      project.status === 'Deployed' ? 'bg-green-900/50 text-green-300 border border-green-400/20' :
                      project.status === 'In Development' ? 'bg-yellow-900/50 text-yellow-300 border border-yellow-400/20' :
